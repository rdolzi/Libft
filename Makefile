...
ft_strnstr.c ft_isascii.c ft_memmove.c ft_strrchr.c ft_strtrim.c \
ft_split.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c \
ft_itoa.c ft_strmapi.c ft_striteri.c ft_strlcat.c \

BONUS = ft_lstnew.c ft_lstadd_front.c ft_lstadd_back.c ft_lstlast.c ft_lstsize.c ft_lstdelone.c ft_lstclear.c ft_lstiter.c ft_lstmap.c
